...
A serverless recipe diary built on AWS, combining a responsive web app with persistent recipe and image storage.
...
* `results/jmeter/` — JMeter test plans and `.jtl` results
* `results/images/` — benchmark payloads
* `results/cloudwatch/` — Lambda metrics
* `results/terminal/` — timing and security validation outputs
